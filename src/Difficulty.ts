...
export const DIFFICULTY_PRESETS: Record<DifficultyPresetKey, DifficultyPreset> = {
  easy: {
    ...
    enemySpawnScale: 0.88,
    enemyCapScale: 0.9,
    powerUpDropScale: 1.22,
    powerUpDurationScale: 1.16,
    ufoSpawnRateScale: 0.9,
    bossChanceScale: 0.72,
    bossHealthScale: 0.82,
    bossAggressionScale: 0.86,
    bossProjectileSpeedScale: 0.9,
    levelCurveScale: 1.08,
  },
  normal: {
    key: 'normal',
    label: 'NORMAL',
  ...
  hard: {
    ...
    enemySpawnScale: 1.16,
    enemyCapScale: 1.1,
    powerUpDropScale: 0.8,
    powerUpDurationScale: 0.86,
    ufoSpawnRateScale: 1.12,
    bossChanceScale: 2,
    bossHealthScale: 1.25,
    bossAggressionScale: 1.2,
    bossProjectileSpeedScale: 1.16,
    levelCurveScale: 0.92,
  },
};
